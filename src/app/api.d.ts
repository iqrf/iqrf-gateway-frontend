    ...
    rsp: {
      ...
      result?: {
        ...
        sensors?: {
          ...
          frcs?: number[];
          /**
           * Parsed generic types if present in device response.
           */
          breakdown?: {
            /**
             * Value type of the sensor (quantity).
...
export interface IqrfSensorFrcRequest100 {
  ...
  data: {
    ...
    req: {
      ...
      param: {
        /**
         * Type of sensor (quantity) to read values of. Refer to the Sensor interoperability standard https://www.iqrfalliance.org/iqrf-interoperability/ for details.
         */
        sensorType: number;
        /**
         * Index of the sensor. When the sensor type is specified, then its is an index among of all sensors of the specified type. Some FRC commands might use top 3 bits of this parameter for passing additional data.
         */
        sensorIndex: number;
        /**
         * One of predefined standard sensor FRC commands. Use FRC commands available from Sensor enumeration.
         */
        frcCommand: number;
        /**
         * Array if integer values corresponding to the selected nodes. Use default value to select all nodes and use sleepAfterFrc parameter.
        ...
        sleepAfterFrc?: {
          /**
           * See DPA documentation https://www.iqrf.org/DpaTechGuide/pages/sleep.html for details.
           */
          time?: number;
          /**
           * See DPA documentation https://www.iqrf.org/DpaTechGuide/pages/sleep.html for details.
...
export interface IqrfSensorReadSensorsWithTypesRequest100 {
  ...
  data: {
    ...
    req: {
      ...
      param: {
        /**
         * Specifies sensors to read data from. Undefined: Missing parameter: reads 1st sensor. Number: -1: reads all sensors. Array: array of indexes: specifies sensors to read.
         */
